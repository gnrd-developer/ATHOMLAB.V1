...
public class MainSecurity {
    ...
    */
    ...
    @Bean//https://frontathomlab-production.up.railway.app/
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors().configurationSource(request -> {
            CorsConfiguration configuration = new CorsConfiguration();
            configuration.setAllowedOriginPatterns(List.of("https://athomlabfront1-production.up.railway.app/", "http://localhost:3000"));
            ...
            return configuration;
                ...
                .authorizeRequests()
                .antMatchers("/auth/login","/auth/register","/auth/logout","/product/**","/category/**","/subcategory/**")
                .permitAll()
